...
To select the dataset on which implement the transfer learning just comment the two you're not interested in and change the name of the saved model in the function that create the model.
