...
if __name__=='__main__':
    ...
    X_train, X_test, Y_train, Y_test = train_test_split(X, age_norm, test_size=0.15, random_state=11)
    ...
    checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
            "3d_age_regression_15_50_100_MAE_MSE_64_128_128_64.h5", save_best_only=True
    )
    ...
    checkpoint_tun = tf.keras.callbacks.ModelCheckpoint(
            "3d_age_regression_15_50_100_MAE_MSE_64_128_128_64_tun.h5", save_best_only=True
    )

    model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=1e-6), loss='MAE', metrics=['MSE'])
